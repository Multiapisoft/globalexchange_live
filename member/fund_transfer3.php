...
<div class="wallet-cards">
    ...
    <div class="transfer-card">
        <div class="transfer-card-body">
            <form action="fund_transfer3_model.php" method="post" id="p2pTransferForm">
                <!-- P2P User ID Field -->
                <div class="form-group">
                    <label class="form-label" for="login_id">Receiver's User ID</label>
                    <div class="input-group">
                        <input class="form-control" type="text" id="receiver_id" style="background-color : rgba(0, 0, 0, 0.2)" value="<?php echo get_user_details($uid)->login_id ?>" readonly name="login_id" maxlength="20" required placeholder="Enter receiver's user ID">
                ...
                <div class="form-group">
                    <label class="form-label" for="type">Fund Type</label>
                     ...
                     <option value="3">Package Wallet</option>
