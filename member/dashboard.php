...
<style>
    ...
    * {
    ...
    .fresh-card {
        ...
        padding: 24px;
        margin: 0 74px 24px 25px !important;
...
<div class="fresh-mobile">
        ...
        <div class="fresh-welcome-content">
            <div class="fresh-welcome-text">
                ...
                <!-- <div class="fresh-user-rank" style="margin-top:8px; display:flex; flex-wrap:wrap; gap:10px; align-items:center;">
                    <span class="fresh-rank-badge" style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); color:#fff; padding:6px 12px; border-radius:8px; font-size:0.9rem; font-weight:600;">
    ...
    <div class="fresh-card" style="margin: 0 74px 24px 25px;">
    ...
    <div class="fresh-portfolio">
            ...
            <div class="fresh-portfolio-grid">
                ...
                <div class="fresh-portfolio-card">
                    ...
                    <!-- <div class="fresh-portfolio-value"><?php echo round($total_in, 2); ?> USDT</div> -->
                    <div class="fresh-portfolio-change positive">
                    <?php echo isset($reward_arr[(int) $user->reward]) ? htmlspecialchars($reward_arr[(int) $user->reward]) : 'No Rank'; ?>
                    </div>
                </div>
                <div class="fresh-portfolio-card">
                    <div class="fresh-portfolio-label">
                    ...
                    <!-- <div class="fresh-portfolio-value"><?php echo round($total_in, 2); ?> USDT</div> -->
                    <div class="fresh-portfolio-change positive">
                    <?php echo isset($royalty_rank_names[(int) $user->royalty]) ? htmlspecialchars($royalty_rank_names[(int) $user->royalty]) : '-'; ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- <div class="fresh-bottom-nav">
     ...
     <div class="fresh-income-section">
        ...
        <div class="fresh-income-grid">
            ...
            <a href="report_royalty.php" class="fresh-income-card" style="text-decoration:none; color:inherit; display:block;">
                <div class="fresh-income-icon">
                    <i class="fas fa-crown"></i>
                </div>
                <div class="fresh-income-content">
                    <div class="fresh-income-label">Reward Income</div>
                    <div class="fresh-income-value">$<?php echo number_format((float) get_sum('income_royalty', 'amount', "uid='" . (int) $uid . "' AND type=0"), 2); ?></div>
            ...
            <?php  /*<div class="fresh-income-card">
                 ...
                 <div class="fresh-income-content">
                     <div class="fresh-income-label">Fast Track Bonus</div>
                     <div class="fresh-income-value">$<?php echo round(get_sum('income_royalty', 'amount', "uid='" . $uid . "' AND type=1") * 1, 2); ?></div>
                     <div class="fresh-income-desc">Leadership rewards</div>
                 </div>
             </div>*/
            ?>

            <a href="report_royalty.php?type=2" class="fresh-income-card" style="text-decoration:none; color:inherit; display:block;">
                <div class="fresh-income-icon">
                    <i class="fas fa-crown"></i>
                </div>
                <div class="fresh-income-content">
                    <div class="fresh-income-label">Royalty Income</div>
                    <div class="fresh-income-value">$<?php echo round(get_sum('income_royalty', 'amount', "uid='" . $uid . "' AND type=2") * 1, 2); ?></div>
                    <div class="fresh-income-desc">Leadership rewards</div>
                </div>
            </a>
        </div>
