...
<style>
    /* Dark theme for mailbox inbox page */
    .mailbox {
                    ...
                    <div class="col-sm-3 p-0 inbox-nav hidden-xs hidden-sm">
                        <div class="mailbox-sideber">
                            <div class="profile-usermenu">
                                <h6>Mailbox</h6>
                                <ul class="nav">
                                    <li class="active"><a href="email_inbox.php"><i class="fa fa-inbox"></i>Inbox</a></li>
                            ...
                            <a href="email.php?recid=<?php echo $row->recid;?>" class="inbox_item <?php if($row->read==0){echo ' unread';}?>">
                                <div class="inbox-avatar">
                                    ...
                                    <div class="inbox-avatar-text">
                                        <div class="avatar-name"><?php if($row->sender!=0){echo $row->name;}else{echo 'Admin';}?> <?php if($row->sender!=0){echo ' ('.$row->login_id.')';}?></div>
