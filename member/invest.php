...
<div class="fresh-container">
    ...
    <div class="fresh-card">
        ...
        <!-- <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="statistic-box statistic-filled-1">
                    <h2><span class="count-number"> <?php echo $user->wallet * 1; ?> </span><span class="slight">
                            <?php echo SITE_CURRENCY; ?></span></h2>
        ...
        <div class="trading-pairs-container">
            ...
            <div class="row my-3" style="flex: 1;">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="fresh-investment-card" style="animation-delay: <?php echo $i * 0.1; ?>s;">
                                ...
                                <div class="fresh-plan-features">
                                    <ul>
                                        <?php if ($row->line1) { ?>
                                            <li><?php echo $row->line1; ?></li><?php } ?>
                                        <?php if ($row->line2) { ?>
                                            <li><?php echo $row->line2; ?></li><?php } ?>
                                ...
                                <div class="fresh-plan-button">
                                    ...
                                    if ($buttonType == 'running'): ?>
                                        <button id="invest-btn-<?php echo $row->recid; ?>" class="fresh-plan-amount running-btn"
                                            disabled>
                                            <i class="fas fa-clock"></i> Left — <span
                                                id="countdown-<?php echo $row->recid; ?>"></span>
                                        </button>
                                    ...
                                    <?php elseif ($buttonType == 'closed' and $userdata->is_closed == 0): ?>
                                        <form action="self_treding_model.php" method="post">
                                            ...
                                            <button type="submit" name="submit-button" style="border-radius:25px;"
                                                class="btn btn-danger btn-lg">
                                                <i class="fas fa-times-circle"></i> Close
                                            </button>
                                        </form>
                                    <?php else: ?>
                                        <button class="fresh-invest-btn"
                                            onclick="window.location.href='invest_now.php?i=<?php echo $row->recid; ?>'">
