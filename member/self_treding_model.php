...
// include_once '../lib/functions.php'; // if incentive() & helpers are here
...
if (isset($_POST['submit-button'])) {
    ...
    // echo "Amount: $amount, I Amount: $iamount, Percentage: $percentage";
    // exit;
    ...
    if ($amount > 0) {
        ...
        // echo "UID: $uid, Amount: $amount, I Amount: $iamount";
        // exit;

        // 4️⃣ Give level ROI
        incentives($uid, $amount, $iamount);
        // incentives(100, 1.12, 100);
    } else {
        // Just update investment as closed
        my_query("UPDATE investments SET  is_closed=1 WHERE recid='$investment_id'");
    }

    // echo "<script>alert('Investment Closed Successfully. ROI + Level income credited.');window.location.href='dashboard.php';</script>";
