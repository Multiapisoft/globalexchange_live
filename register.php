...
if(isset($_GET['r']) && !empty($_GET['r'])){$uid = $_GET['r'];}
elseif(isset($_SESSION['userid']) && !empty($_SESSION['userid'])){$uid = $_SESSION['userid'];}
else{$uid = '100';}
redirect('member/register.php?r='.$uid);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <head>
        ...
        <script>var usd_trx = <?php echo USD_TRX;?></script>
        <?php }elseif(SITE_CURRENCY_ == 'BNB'){?>
        <script>
        var usd_trx = 1<?php //echo USD_TRX;?>;
        var usd_coin_rate = 1<?php //echo TKN_RATE_USD;?>;
        </script>
...
.input100 {
  color: #000;
    ...
    <body>
                    ...
                    <div class="login100-form">
                        <form class="w-100 validate-form" onsubmit="return false" id="signupform">
                            ...
                            <p class="text-center text-azure m-b-5" style="color: #d4d8d8;">
                                You don't have referral code use ' 100 ' as referral id.
                            </p>

                            <div class="wrap-input100 validate-input m-b-20" data-validate="Type user name">
                                <input id="first-name" class="input100" type="text" name="referral" placeholder="Enter Referral code" value="<?php echo $uid;?>">
                                <span class="focus-input100"></span>
                            </div>
                            
                            <?php /*<div class="wrap-input100 validate-input m-b-20">
                                <select name="position" id="position" class="input100" style="width:100%;" required="required">
                            ...
                            <p class="m-b-15 text-right text-white">Allready have account? <a href="./" class="text-white"> Sign in</a></p>
                            <div class="container-login100-form-btn">
                                <button class="login100-form-btn" id="lgmbtnsup" onclick="SignUp()">
                                    Sign up
                                </button>
                            </div>
        ...
        <!-- particle js-->
        <script src="../contract/Content/assets/js/particles.min.js"></script>
